...
import { buildsTemplate, mkSchemasList } from '../__utils__/schemas';

const absoluteSchemaDir =
  'D:\\my-projects\\hardocs\\REPOS\\hardocs-vue-client\\__tests__\\__fixtures__\\';
...
describe('Json schemas loader and templates based on schemas', () => {
  ...
  describe('The vuex state management layer', () => {
    ...
    it('Creates a new object in the store based on a selected json schema', () => {
      ...
      expect(Object.keys(store.state.metadata.dataSet[0])).toBe(key);
    });
